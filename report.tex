...
\newcommand\pretextual{%
  ...
  \AtBeginShipout{\stepcounter{TotPages}}
}
...
\renewcommand*{\maketitle}{%
  ...
  \vfill
  \begin{center}
     \scshape\centering\onehalfspacing\fontsize{4mm}{6mm}\selectfont Dipartimento di Ingegneria Meccanica e Aerospaziale\\Università di Roma La Sapienza\\Corso di Ingegneria Meccanica\\[1cm]
  \end{center}
  \vfill
  \begin{center}
